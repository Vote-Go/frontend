    ...
    <>
      ...
      <Container>
        <div className="text-center">
          <h1 className="title mb-6 title-alt">Predict. Vote. Earn.</h1>
          <p className="text-xl hover-text-alt mb-12 max-w-2xl mx-auto ">
            Decentralized prediction market platform where your insight meets
            opportunity
          </p>
        </div>
      </Container>
      ...
      <Container>
        <FeaturesList>
          ...
          <FeaturesListItem title="Quick Introduction">
